...
$(document).ready(function() {
  ...
  $('.gallery-owl').owlCarousel({
    ...
    margin:10,
    nav:true,
    navText: ["<div class='gall-nav nav-btn nav-prev'><div class='img-box'><img src='"+baseUrl+"common/img/right-chevron.svg' alt='Icon'></div></div>", "<div class='gall-nav nav-btn nav-next'><div class='img-box'><img src='"+baseUrl+"common/img/right-chevron.svg' alt='Icon'></div></div>"],
...
// See More ==================================================================================
$(document).ready(function() {
  $(".smore-btn").click(function () {
    $(this).toggleClass("active");
    if($(".smore-block").hasClass("not-active")) {
        $(this).text("See Less");
    } else {
        $(this).text("See More");
    }

    $(".smore-block").toggleClass("not-active");
  });
});

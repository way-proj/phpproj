...
function get_checkout($cart_id){
  ...
  function fetch_single_details($cart_id)
    ...
    return $output;
        ...
        public function save_customer_data($insert_data){
                $res=$this->db->insert('tbl_customers',$insert_data);
                $insert_id = $this->db->insert_id();
              return $insert_id;
              //echo $this->db->last_query();
             }
        public function save_news_data($insert_data){
        ...
        public function update_customer_data($insert_data,$user_id){
              $this -> db -> where('customer_id', $user_id);
        ...
        public function save_contact_data($insert_data){
                $res=$this->db->insert('tbl_contact',$insert_data);
                $insert_id = $this->db->insert_id();
              return $insert_id;
              //echo $this->db->last_query();
             } 

               ...
               <div class="col-md-8">
                  <div class="card blog mb-4">
                     <div class="blog-header">  
                        <a href="#"><img class="card-img-top" src="<?php echo base_url();?>images/blog/2.webp" alt="Card image cap"></a>
                     </div>
                     <div class="card-body">
                        ...
                        <div class="gallery mb-4">
                           <div class="row">
                              <div class="col-sm-4"><img class="rounded" alt="" src="<?php echo base_url();?>images/blog/3.webp"></div>
                              <div class="col-sm-4"><img class="rounded" alt="" src="<?php echo base_url();?>images/blog/2.webp"></div>
                              <div class="col-sm-4"><img class="rounded" alt="" src="<?php echo base_url();?>images/blog/1.webp"></div>
                           </div>
                        </div>
                        <p>Praesent aliquam, enim at fermentum mollis, ligula massa adipiscing nisl, ac euismod nibh nisl eu lectus. Fusce vulputate sem at sapien. Vivamus leo. Aliquam euismod libero eu enim. Nulla nec felis sed leo placerat imperdiet. Aenean suscipit nulla in justo.</p>
                        ...
                        <div class="gallery mt-4 mb-4">
                           <div class="row">
                              <div class="col-sm-6"><img alt="" class="rounded" src="<?php echo base_url();?>images/blog/2.webp"></div>
                              <div class="col-sm-6"><img alt="" class="rounded" src="<?php echo base_url();?>images/blog/3.webp"></div>
                           </div>
                        </div>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Non, ipsum facilis, eaque aliquid porro deleniti architecto eum perferendis quidem modi quo reiciendis dolor deserunt beatae repellat, nostrum aut fuga. Rem?</p>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reiciendis sunt a quam, exercitationem, provident numquam quia eius optio quos vitae odio impedit ipsum voluptatem earum neque architecto enim quisquam, ea.</p>
                  ...
                  <div class="card padding-card reviews-card mb-4">
                     <div class="card-body">
                        ...
                        <div class="media mb-4">
                           <img alt="" src="<?php echo base_url();?>images/user/1.webp" class="d-flex mr-3 rounded">
                        ...
                        <div class="media">
                           <img alt="" src="<?php echo base_url();?>images/user/2.webp" class="d-flex mr-3 rounded">
                           <div class="media-body">
                              ...
                              <div class="media mt-4">
                                 <img alt="" src="<?php echo base_url();?>images/user/3.webp" class="d-flex mr-3 rounded">
                                 <div class="media-body">
               ...
               <div class="col-md-4">
                  ...
                  <div class="card sidebar-card mb-4">
                     <div class="card-body">
                        ...
                        <p class="mb-0"><i class="mdi mdi-calendar-text"></i> April 05, 2018</p>
                        <hr>
                        <a href="#">
                           <h6>Nulla malesuada mauris non nulla imperdiet ullamcorper</h6>
                        </a>
                        <p class="mb-0"><i class="mdi mdi-calendar-text"></i> June 20, 2018</p>
                        <hr>
                        <a href="#">
                           <h6 class="text-success">Focus on creating and growing your projects and websites</h6>
                        </a>
                        <p class="mb-0"><i class="mdi mdi-calendar-text"></i> June 29, 2018</p>
                        <hr>
                        <a href="#">
                           <h6>Vestibulum lobortis urna eu mauris viverra porttitor. Cras consequat </h6>
                        </a>
                        <p class="mb-0"><i class="mdi mdi-calendar-text"></i> October 10, 2018</p>
                        <hr>
                        <a href="#">

...
<div class="filter-block">
	...
	<ul class="category-list">
		...
		<div class="filter-block">
			<h5>Brands</h5>
			<ul class="category-list brands-list" id="myList">
			...
			<div id="loadMore" class="smore-btn">Load more</div>
			<div id="showLess" class="smore-btn active">Show Less</div>
		</div>
		</div>
	</div>
</div>
...
<div class=" prod-item-box product-box education"> 
	...
	<!--<a href="<?php echo site_url(); ?>Pages/getProductDetails/<?php echo $value->id;?>" class="link-btn">Know More</a>-->
		<a href="<?php echo base_url().'admin/upload/brochure/'.$value->brochure_file; ?>">
							<figure><img src="<?php echo base_url()?>assets/img/pdf-icon.jpg" alt=""></figure>Download Brochure
					</a>
...
<?php } } else { ?>
	...
	<div class=" prod-item-box product-box education"> 
		...
		<div class="prod-mob-wrp">
			...
			<a href="<?php echo base_url().'admin/upload/brochure/'.$value['brochure_file'];?>">
							<figure><img src="<?php echo base_url()?>common/img/pdf-icon.jpg" alt=""></figure>Download Brochure
					</a>
			<div class="prod-action">
				<button class="img-box" type="button" data-bs-toggle="modal" data-bs-target="#talk-modal">
					<img src="<?php echo base_url(); ?>common/img/f-btn-icon.svg" alt="">

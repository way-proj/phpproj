        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                ...
                <!--<li><a href="<?php echo base_url() . "Productmaster/company_list" ?>"><i class="fa fa-circle-o text-aqua"></i>Company</a>
				 ...
				 <li><a href="<?php echo base_url() . "Industrytype/manage_industrytype" ?> "><i class="fa fa-circle-o text-aqua"></i>Brands</a>
                 </li>  
           ...
           <li class="treeview">
			...
			<!--<li class="treeview">
                <a href="#">
                    <i class="fa fa-envelope"></i> <span>Service</span>
                    <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                    </span>
                </a>
               <ul class="treeview-menu">
                    <li><a href="<?php echo base_url() . "Services/manage_services" ?>"><i class="fa fa-circle-o text-yellow"></i>Service List</a></li>
            ...
            <!--<li class="treeview">
                <a href="#">
                <i class="fa fa-table"></i> <span>Home Portfolio</span>
                <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
                </span>
                </a>
                <ul class="treeview-menu">
                 <li><a href="<?php echo base_url() . "Portfolio/manage_portfolios" ?> "><i class="fa fa-circle-o text-aqua"></i>All Portfolio</a>
                 </li> 
                </ul>
			</li>-->
			<li class="treeview">
                ...
                <ul class="treeview-menu">
                 <li><a href="<?php echo base_url() . "Software/manage_softwares" ?> "><i class="fa fa-circle-o text-aqua"></i>All Softwares</a>
                 </li> 
                </ul>
			</li>
			...
			<!--<li class="treeview">
                <a href="#">
                <i class="fa fa-table"></i> <span>Industry Type</span>
                <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
                </span>
                </a>
                <ul class="treeview-menu">
                 <li><a href="<?php echo base_url() . "Industrytype/manage_industrytype" ?> "><i class="fa fa-circle-o text-aqua"></i>All industrytype</a>
                 </li> 
                </ul>
			</li>-->
			<!--<li class="treeview">
                <a href="#">
                    <i class="fa fa-envelope"></i> <span>Footer Link</span>
                    <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                    </span>
                </a>
                <ul class="treeview-menu">
                    <li><a href="<?php echo site_url('footer-link');?>"><i class="fa fa-circle-o text-yellow"></i>Footer link</a></li>

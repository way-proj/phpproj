...
$route['footer-link'] = 'Fscontroller/index';
//$route['call'] = 'Fscontroller/setcall';
//$route['category'] = 'Fscontroller/setcategory';
//$route['help'] = 'Fscontroller/sethelp';
$route['social'] = 'Fscontroller/setsocial';
//$route['contact'] = 'Fscontroller/setcontact';

		...
		<div class="content-wrapper">
               ...
               <div class="content-header">
                ...
                <h4><strong><?php //echo getParentChildCatgeory($parent_id);?>Portfolio</strong></h4>


                <ol class="breadcrumb">
                    <li><a href="<?php echo base_url()?>"><i class="fa fa-dashboard"></i> Home</a></li>
                    <li><?php //echo displaystreamlink($parent_id);?>Portfolio</li>
                        
                       <div class="pull-right"><a href="<?php echo base_url()?>Portfolio/add_manage_portfolios?parent_id=<?php echo $parent_id?>" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="Add New"><i class="fa fa-plus"></i></a> <a href="#" data-toggle="tooltip" title="" class="btn btn-default" data-original-title="Rebuild"><i class="fa fa-refresh"></i></a>
                ...
                <button type="button" data-toggle="tooltip" title="" class="btn btn-danger delete_all"  data-original-title="Delete" data-url="<?php echo base_url();?>/Portfolio/deleteAll"><i class="fa fa-trash-o"></i></button>
                </div>
                </ol>
                </div>
                </div>
                            ...
                            <div class="box">
                                ...
                                <div class="box-body">
                                    ...
                                    <table id="portfolio_view" class="table table-bordered table-striped">
                                        ...
                                        foreach ($manage_portfolios as $row) {
                                                  ?>
                                        <tr>
										...
										<td><?php echo $row->url; ?></td>
										  ...
										  <td><?php 
									   if(!empty($row->portfolio_image)){
										   ?>
											 <img src="<?php echo base_url().'upload/portfolio_image/'.$row->portfolio_image?> " width="50">
										   <?php
									   }else{
										   ?>
									   ...
									   ?>
									    ...
									    <td>
									  	<?php 
									   if(!empty($row->portfolio_logo)){
										   ?>
											  <img src="<?php echo base_url().'upload/portfolio_image/'.$row->portfolio_logo?> " width="50">
										   <?php
									   }else{
										   ?>
                                ...
                                <td>
                                <!--	<a  style="padding-left: 2em;" href="<?php echo site_url();?>Portfolio/add_manage_portfolios/<?php echo @$row->id;?>?parent_id=<?php echo $parent_id;?>"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>-->
							   <a  style="padding-left: 2em;" href="<?php echo site_url();?>Portfolio/add_manage_portfolios/<?php echo @$row->id;?>"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>	
							   
                                <!--<a  style="padding-left: 2em;" href="<?php echo site_url();?>Portfolio/deletePortfolios/<?php echo @$row->id;?>?parent_id=<?php echo $parent_id;?>" onclick="confirm('Are you sure you want to delete?')"><span class="glyphicon glyphicon glyphicon-trash" aria-hidden="true"></span></a>-->
							
							<!-- Delete section-->
							  <a  style="padding-left: 2em;" onclick="deletes('tbl_portfolio','id','<?php echo $row->id; ?>','portfolio_list')"><span class="glyphicon glyphicon glyphicon-trash" aria-hidden="true"></span></a>								
                                <!-- delete section-->                 
                                            </td>
                                           </tr>
                                          <?php    }?>

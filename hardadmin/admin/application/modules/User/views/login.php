...
<div class="user">
    ...
    <div class="panelpart">
		...
		<img src="<?php base_url();?>admin_asset/images/brand.png" class="img-responsive center-block">
		<p>Admin Login</p>
		</div>
		...
		<div style="margin-top: 0px; color: red;" class="error_ad"><?php echo form_error('email'); ?></div>
							...
							<div class="input-group">
								...
								<div class="input-group-addon"><i class="fa fa-user" style="color:#ff003c  !important"></i></div>
                ...
                <div class="form-group fontst">
							...
							<div class="input-group">
								...
								<div class="input-group-addon"><i class="fa fa-lock" style="color:#ff003c  !important"></i></div>
                        ...
                        <div class="row" style="margin-bottom:12px;"><br>
							...
							<div class="col-xs-12">
                               ...
                               <div class="text-center">
									...
									<button type="submit" name="submit" class="primary-btn" value="Log in">Log in</button>
                                    </div>    

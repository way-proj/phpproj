		<div class="content-wrapper">
              <div class="content-header">
                ...
                <h4><strong><?php //echo getParentChildCatgeory($parent_id);?>Brands</strong></h4>
				<ol class="breadcrumb">
                  <li><a href="<?php echo base_url()?>"><i class="fa fa-dashboard"></i> Home</a></li>
                  <li>Brands</li>
                <div class="pull-right"><a href="<?php echo base_url()?>Industrytype/add_manage_industrytype" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="Add New"><i class="fa fa-plus"></i></a> <a href="#" data-toggle="tooltip" title="" class="btn btn-default" data-original-title="Rebuild"><i class="fa fa-refresh"></i></a>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box">
                                   ...
                                   <table id="portfolio_view" class="table table-bordered table-striped">
                                       <thead>
                                        ...
                                        <tbody>
                                         <?php
                                        $i=1;
                                        foreach ($manage_industrytype as $row) {
                                        ?>
                                        <tr>
                                        <td><input type="checkbox" class="sub_chk" data-id="<?php echo $row->id; ?>"></td>
                                        <td><?php echo $row->industrytype_title;?></td>
										<td><?php echo $row->industrytype_desc;?></td>
										<!--<td><?php echo $row->url; ?></td>
									  	<td><?php 
									   if(!empty($row->software_image)){
										   ?>
										<img src="<?php echo base_url().'upload/software_image/'.$row->software_image?> " width="50">
										   <?php
									   }else{
										   ?>
										<?php
									...
									<!--<td>
									  	<?php 
									   if(!empty($row->software_logo)){
										   ?>
											  <img src="<?php echo base_url().'upload/software_image/'.$row->software_logo?> " width="50">
										   <?php
									   }else{
										   ?>
                                ...
                                <td>
								<a  style="padding-left: 2em;" href="<?php echo site_url();?>Industrytype/add_manage_industrytype/<?php echo @$row->id;?>"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>	
							   
								<!-- Delete section-->
							  <a  style="padding-left: 2em;" onclick="deletes('tbl_industrytype','id','<?php echo $row->id; ?>','manage_industrytype')"><span class="glyphicon glyphicon glyphicon-trash" aria-hidden="true"></span></a>								
                                <!-- delete section-->                 
                                            </td>
                                           </tr>
                                          <?php    }?>

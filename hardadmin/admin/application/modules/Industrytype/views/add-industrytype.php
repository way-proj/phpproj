       <div class="content-wrapper">
                ...
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li><a class="active" href="<?php echo base_url()?>Industrytype/manage_industrytype">Brands</a></li>
                    ...
                    <a href="<?php echo base_url();?>Industrytype/manage_industrytype" data-toggle="tooltip" title="" class="btn btn-default" data-original-title="Cancel"><i class="fa fa-reply"></i></a></div>
                </ol>
             ...
             <div class="col-md-12">
              ...
              <div class="nav-tabs-custom">
                ...
                <form action="<?php echo base_url();?>/Industrytype/save_industrytype_data" method="post" enctype="multipart/form-data" id="form-category" class="form-horizontal">
                
                
                <input type="hidden" name="industrytype_id" value="<?php echo @$single_industrytype_data->id;?>">
                ...
                <div class="col-sm-10">
                <input type="text" name="industrytype_title" id="industrytype_title" value="<?php echo set_value('industrytype_title'); ?><?php echo @$single_industrytype_data->industrytype_title;?>" placeholder="Name" class="form-control">
                <?php echo form_error('industrytype_title', '<div class="error"><p style="color:red">', '</p></div>'); ?>
                </div>
                </div>
                ...
                <div class="col-sm-10">
                <input type="hidden" name="old_image" value="<?php echo @$single_industrytype_data->industrytype_image;?>">
               <?php
				  if(!empty($single_industrytype_data->industrytype_image)){
					  ?>
				<img src="<?php echo base_url().'upload/industrytype_image/'.$single_industrytype_data->industrytype_image?> " width="50">
					  <?php
				  }
               ?>
			    <input type="file" name="industrytype_image"  id="industrytype_image"  onchange="loadFile(event)">
                ...
                <div class="col-sm-10">
                <textarea  name="description" id="description" class="tincyeditor"><?php echo @$single_industrytype_data->industrytype_desc;?></textarea>
                </div>
                </div>

		<div class="content-wrapper">
              <div class="content-header">
                ...
                <h4><strong><?php //echo getParentChildCatgeory($parent_id);?>Software</strong></h4>
				<ol class="breadcrumb">
                  <li><a href="<?php echo base_url()?>"><i class="fa fa-dashboard"></i> Home</a></li>
                  <li>Software</li>
                <div class="pull-right"><a href="<?php echo base_url()?>Software/add_manage_softwares" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="Add New"><i class="fa fa-plus"></i></a> <a href="#" data-toggle="tooltip" title="" class="btn btn-default" data-original-title="Rebuild"><i class="fa fa-refresh"></i></a>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box">
                                ...
                                <td>
								<a  style="padding-left: 2em;" href="<?php echo site_url();?>Software/add_manage_softwares/<?php echo @$row->id;?>"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>	
							   
								<!-- Delete section-->
							  <a  style="padding-left: 2em;" onclick="deletes('tbl_software','id','<?php echo $row->id; ?>','software_list')"><span class="glyphicon glyphicon glyphicon-trash" aria-hidden="true"></span></a>								
                                <!-- delete section-->                 
                                            </td>
                                           </tr>
                                          <?php    }?>

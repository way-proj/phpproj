...
function get_product(){
   ...
   function brand_list(){
	...
	public function deletes1($table, $field, $delete_id) {
        ...
        return ($this->db->trans_status() === FALSE) ? FALSE : TRUE;
         ...
         function single_software_list($id){
          $this->db->select("*");
          $this->db->from("tbl_software");
          $this->db->where('id',$id);
          $query=$this->db->get();
   ...
   /*   public function delete_data($table, $field, $delete_id) {
	...
	public function update_sofware_long_data($post_data,$sid){
      //printarray($post_data);die;
				...
				if($sid){
                 $update_data=array(
					  ...
					  'text12'=>$text12
        			    ...
        			    if($lid)
        			    {
        			     $this->db->where('id',$lid);
                          ...
                          $this->db->update('software_long_desc',$update_data);  
        			    }
        			    else
        			    {
        			 $insert_data=array(
        			 ...
        			 $this->db->insert('software_long_desc',$insert_data);  
        			    }
	...
	public function save_software($post_data){
	...
	function Get_long_desc($sid){
         $this->db->select("*");
         $this->db->from("software_long_desc");
         $this->db->where('software_id',$sid);
         $query=$this->db->get();
         //echo $this->db->last_query();
         $res=$query->result();
         return $res;

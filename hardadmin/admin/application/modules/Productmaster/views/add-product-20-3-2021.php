...
<?php }?>
 <div class="form-group">
               ...
               <div class="form-group" id="onchange_div2">
                ...
                <div class="form-group">
                <label class="col-sm-2 control-label" for="input-subtract">industry<span style="color:red">*</span></label>
                <div class="col-sm-10">
...
<?php
							...
							<table id="category_view" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                          <tr><td>
                                            <a style="width:30px; float: left" onclick="set_tr_edit(<?php echo end($ar);?>)" href="#" class=" icon-plus icon-2x margin-top-8">Add(+)</a>
